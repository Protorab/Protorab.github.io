jQuery(document).ready(function ($) {
	...
	$('.cd-radial-slider .cd-radial-slider-content').clone().prependTo('.cd-radial-slider'); // Копия последнего слайда помещается в начало.
	$('.cd-radial-slider .cd-radial-slider-content').eq(1).clone().appendTo('.slider'); // Копия первого слайда помещается в конец.  
